...
import { Particle, ParticleArgs } from '../library/Particle.js';
...
function update() {
    ...
    for(const particle of particles) {
        const bitmap = color2ImageSource.get(particle.color) as ImageSource;
        ctx.drawImage(
            bitmap,
            0,
            0,
